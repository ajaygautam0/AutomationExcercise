...
//			  WebElement ho = driver.findElement(By.xpath("//a[contains(text(), 'Add to cart') and @data-product-id='1']"));
		...
		em.sendKeys("lolll120@gmail.com");
		...
		if (deliveryAddress.equalsIgnoreCase(billingAddress)) {
			...
			Thread.sleep(1000);
			// Review
			String revieworder = driver.findElement(By.xpath("//*[@id=\"cart_info\"]/table/tbody/tr[2]/td[3]/h4/b"))
					.getText();
			...
			if (YourorderhasbeenplacedsuccessfullyTitle.equalsIgnoreCase("Automation Exercise - Order Placed")) {
				System.out
						.println("***************** Your order has been placed successfully! Verified **************");
			}

			Thread.sleep(1000);
			// Download invoice
			WebElement downloadButton = driver.findElement(By.xpath("//*[@id=\"form\"]/div/div/div/a"));
			downloadButton.click();
			
//			String downloadinvoiceTitle = driver.getTitle();
//			if (downloadinvoiceTitle.equalsIgnoreCase("Automation Exercise - Order Placed")) {
				System.out.println("***************** Download invoice successfully **************");
//			}
