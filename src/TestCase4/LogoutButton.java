...
public class LogoutButton {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		em.sendKeys("aj05@gmail.com");
			   ...
			   //Sign Up Button
	    WebElement Button	= driver.findElement(By.cssSelector("#form > div > div > div:nth-child(3) > div > form > button"));
			    Button.click();
	   ...
	   */
	    ...
	    String LoggedinasusernamePageTitle = driver.getTitle();
	   	if(LoggedinasusernamePageTitle.equalsIgnoreCase("Automation Exercise - Signup / Login")) {
	   		System.out.println("***************** Logged Page Verified **************");
	   		}
